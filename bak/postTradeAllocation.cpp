...
* @Last Modified time: 2020-06-16 00:28:46
*/
...
static void postTradeAllocation(vector<accountDetails> accounts, string fileName, string symbol2, vector <double> rollDate,
		string whichAction,char criteriaOption,double sanityOnNetPosition, int whichOrder){
	...
	int onePtValue = 1000; //hardcoding
	
	vector< vector <double> > INPUT = filledOrdersManager(fileName, symbol2, whichAction, whichOrder);
